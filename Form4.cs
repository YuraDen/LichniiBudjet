...
namespace LichniiBudjet
{
    public partial class Form4 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            ciM.Parameters.AddWithValue("@Nazv", comboBox3.Text);
            int indM = Convert.ToInt32(ciM.ExecuteScalar());
            MySqlCommand cip = new MySqlCommand("update sber set Summa=@Summa, DohRash=@DohRash, Balans=@Balans, Den=@Den, Mes=@Mes, God=@God, Primechanie=@Primechanie where ID=@ID", con);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            B -= ib;
            con.Open();
            MySqlCommand cup = new MySqlCommand("delete from sber where ID=@ID", con);
